    ...
    <div class="report-resource-container">
        ...
        <div class="report-section">
            ...
            <div class="form">
                ...
                <label class="resource-report-option">
                    ...
                    <div class="ml8">
                        ...
                        <div class="report-body-input-container">
                            <textarea name="content" class="report-body-input" placeholder="{{ __('Be specific and detailed') }}" autocomplete="off"></textarea>
                            <p class="no-margin ml4 fs12 gray report-body-counter mt4"><span class="report-body-count"></span> <span class="report-body-count-phrase">{{ __('Enter at least 10 characters') }}</span></p>
                            <input type="hidden" class="enter-at-least-10-chars-text" value="{{ __('Enter at least 10 characters') }}">
            ...
            <div class="align-center" style="margin-top: 12px">
                <div class="typical-button-style dark-bs dark-bs-disabled submit-report align-center">
