    ...
    <div class="post-management-panel-section-content">
        ...
        @if($post)
            ...
            <div class="flex">
                ...
                <div class="typical-button-style white-bs align-center mr8 update-post-status" style="padding: 5px 11px;">
            ...
            <div class="my8 simple-line-separator"></div>
            <!-- publish post -->
            <div class="typical-button-style dark-bs full-center update-post-status mt8" style="padding: 8px 11px;">
                <div class="relative size14 mr4">
