<div id="faq-{{ $faq->id }}-box" class="faq-component">
        ...
        <div class="move-to-right align-center height-max-content">
            <div class="relative">
                ...
                <div class="typical-suboptions-container suboptions-container width-max-content" style="right: 0; max-width: 150px;">
                    ...
                    @endif
                    <!-- Edit faq -->
                    <div class="suboption-style-1 mb2 open-faq-edit-container">
                        ...
                        <span class="fs12 bold dark unselectable">Edit faq</span>
                    </div>
                    <!-- Delete faq -->
                    <div class="suboption-style-1 mb2 open-faq-delete-container">
                        <svg class="size13 mr6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M300,416h24a12,12,0,0,0,12-12V188a12,12,0,0,0-12-12H300a12,12,0,0,0-12,12V404A12,12,0,0,0,300,416ZM464,80H381.59l-34-56.7A48,48,0,0,0,306.41,0H205.59a48,48,0,0,0-41.16,23.3l-34,56.7H48A16,16,0,0,0,32,96v16a16,16,0,0,0,16,16H64V464a48,48,0,0,0,48,48H400a48,48,0,0,0,48-48h0V128h16a16,16,0,0,0,16-16V96A16,16,0,0,0,464,80ZM203.84,50.91A6,6,0,0,1,209,48h94a6,6,0,0,1,5.15,2.91L325.61,80H186.39ZM400,464H112V128H400ZM188,416h24a12,12,0,0,0,12-12V188a12,12,0,0,0-12-12H188a12,12,0,0,0-12,12V404A12,12,0,0,0,188,416Z"></path></svg>
                        <span class="fs12 bold dark unselectable">Delete faq</span>
                    </div>
                </div>
            </div>
            <div class="gray height-max-content mx8 fs10">•</div>
            <p class="no-margin fs11 bold dark mr4 no-wrap">priority :</p>
    ...
    <div class="faq-edit-container none">
        ...
        <label for="{{ 'faqa-' . $faq->id }}" class="fs12 bold dark flex mt8 mb2">Answer</label>
