    ...
    <div class="comment-section">
        ...
        <div class="comment-container">
            ...
            <div class="comment-wrapper">
                <div class="comment-content-and-buttons">
                    ...
                    <div class="comment-clap-and-reply-container">
                        <div class="button-style-4 @auth clap @else login-required @endauth @if($claped) comment-claped @endif">
                            ...
                            <span class="claps-count mr4 @if(!$comment->reactions_count) none @endif">{{ (int) $comment->reactions_count }}</span>
                        ...
                        <div class="relative">
                            ...
                            <div class="suboptions-container typical-suboptions-container width-max-content" style="right: 0;">
                                ...
                                <div class="suboption-style-2 align-center appearence-toggle shrink">
                                ...
                                @can('able_to_update', $comment)
                                <div class="suboption-style-2 align-center mt2 open-comment-update-input">
                                ...
                                @endcan
                                @can('able_to_delete', $comment)
                                <div class="suboption-style-2 align-center mt2 open-comment-delete-viewer">
                                ...
                                <div class="suboption-style-2 align-center mt2 open-comment-report-dialog">
                                    ...
                                    <input type="hidden" class="reportable-id" value="{{ $comment->id }}" autocomplete="off">
                                    <input type="hidden" class="reportable-type" value="comment" autocomplete="off">
                                </div>
                                @endcan
                            </div>
                        </div>
