            ...
            <div class="viewer-content-box viewer-box-style-1">
                ...
                <div class="viewer-scrollable-box y-auto-overflow" style="padding: 14px; max-height: 470px">
                    ...
                    <div>
                        ...
                        <div class="mb8">
                            <label for="create-role-title-input" class="align-center bold forum-color fs13">{{ __('Title') }}<span class="error-asterisk ml4">*</span></label>
                        ...
                        <div class="mb8">
                            <label for="create-role-slug-input" class="align-center bold forum-color fs13">{{ __('Slug') }}<span class="error-asterisk ml4">*</span></label>
                        ...
                        <div class="mb8">
                            <label for="create-role-description-input" class="align-center bold forum-color mb4 fs13">{{ __('Description') }}<span class="error-asterisk ml4">*</span></label>
        ...
        @else
                    ...
                    <div class="viewer-scrollable-box y-auto-overflow" style="padding: 14px; max-height: 430px">
                        ...
                        <div style="margin-top: 12px">
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <div id="role-members-search-result-box" class="full-width scrolly none" style="max-height: 246px;">
                                        <input type="hidden" id="rum-k" autocomplete="off">
                                        <div class="results-container none">
                                            results
                                        </div>
                                        <div class="role-member-search-user role-member-search-user-factory mb4 flex none">
                                            <input type="hidden" class="rum-uid" autocomplete="off">
                                            <a href="" class="rum-profilelink" style="height: 54px">
                                                <img src="" class="size48 rounded mr8 rum-avatar" alt="" style="border: 3px solid #9f9f9f;">
                                            </a>
                                            <div>
                                                <span class="block bold rum-fullname">Mouad Nassri</span>
                                                <span class="block bold fs13 lblack rum-username">codename49</span>
                                                <span class="block bold fs12 blue rum-role">Site owner</span>
                                            </div>
                                        ...
                                        <div id="role-users-fetch-more-results" class="full-center none" style='height: 32px;'>
                        ...
                        <div style="margin-top: 12px">
                            ...
                            <div class="selected-role-member-to-get-role selected-role-member-to-get-role-factory mb4 mr4 full-center flex-column relative none">
                                ...
                                <a href="" class="sum-profilelink" style="height: 54px">
            ...
            <div class="flex" style="margin-bottom: 16px">
                <div id="update-role-section" class="role-section height-max-content mr8">
                    ...
                    <div class="mb8">
                        <label for="update-role-title-input" class="align-center bold forum-color fs13">{{ __('Title') }}<span class="error-asterisk ml4">*</span></label>
                        <p class="no-margin fs12 mb2 gray">Role title should contain only characters.</p>
                    ...
                    <div class="mb8">
                        <label for="update-role-slug-input" class="align-center bold forum-color fs13">{{ __('Slug') }}<span class="error-asterisk ml4">*</span></label>
                        <p class="no-margin fs12 mb2 gray">Role slug should be a dashed version of title. (dashed-version-of-title)</p>
                    ...
                    <div class="mb8">
                        <label for="update-role-description-input" class="align-center bold forum-color mb4 fs13">{{ __('Description') }}<span class="error-asterisk ml4">*</span></label>
                ...
                <div id="update-role-settings-section" class="role-section height-max-content">
                    ...
                    <div class="flex flex-wrap typical-section-style" style="margin: 12px 0; max-height: 250px; overflow-y: auto;">
                        <style>
                            .rounded-entity-for-role {
                                width: 50px;
                                height: 50px;
                                border-radius: 50%;
                                border: 4px solid #52affb;
                            }
                            .rounded-blue-when-hover:hover {
                                background-color: #52affb;
                                color: white;
                                fill: white;
                            }
                            .open-revoke-role-dialog {
                                right: -11px;
                                top: -9px;
                                position: absolute;
                                width: 20px;
                            ...
                            .open-revoke-role-dialog:hover {
                                background-color: #d9d9d9;
                            }
                        </style>
                        <div class="mx8 my8 flex-column full-center rounded-entity-for-role rounded-blue-when-hover pointer open-role-grant-dialog">
                        ...
                        <div class="gray height-max-content mx8 fs10" style="margin-top: 30px">•</div>
                        @foreach($users as $user)
                        <div class="align-center flex-column mx8 my8">
                            <div class="relative">
