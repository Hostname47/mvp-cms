                ...
                <div class="viewer-box-style-1" style="width: 600px;">
                    <div class="flex align-center space-between light-gray-border-bottom" style="padding: 14px;">
                        <div class="flex align-center">
                            ...
                            <span class="fs20 bold dark">Detach permission from members</span>
                        </div>
                        <div class="pointer fs20 close-global-viewer unselectable">✖</div>
                    </div>
                    <div class="viewer-scrollable-box scrolly" style="padding: 14px; max-height: 430px">
                        ...
                        <div style="margin-top: 14px">
                            <div>
                                <p class="no-margin fs12 dark bold align-center">Permission : <span class="ml4 dark fs16">{{ $permission->title }} permission</span></p>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 12px">
                            <p class="no-margin mb2 bold dark fs15">Confirmation</p>
                            <p class="no-margin mb4 dark">Please type <strong>{{ auth()->user()->username }}::detach-permission::{{ $permission->slug }}</strong> to confirm.</p>
                            <div>
                                <input type="text" autocomplete="off" class="full-width styled-input" id="detach-permission-from-users-confirm-input" style="padding: 8px 10px" placeholder="confirm detach">
                            ...
                            <div class="flex" style="margin-top: 12px">
                                <div id="detach-permission-from-users-button" class="typical-button-style red-bs red-bs-disabled full-center">
                                    <div class="relative size14 mr4">
                    ...
                    <div>
                        ...
                        <div class="typical-section-style flex flex-wrap" style="padding: 20px; max-height: 250px; overflow-y: auto; gap: 15px;">
                            ...
                            <div class="align-center flex-column permission-user-box">
                                <img src="{{ $user->avatar(100) }}" class="rounded-entity-for-permission" alt="">
                                <span class="bold dark-blue fs11 username mt4">{{ $user->username }}</span>
                                @if($hr = $user->high_role())
                                <span class="bold dark fs10">{{ $hr->title }}</span>
                                @else
                                <em class="light-gray fs10">normal user</em>
