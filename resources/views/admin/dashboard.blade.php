                ...
                <div>
                    ...
                    <div class="dashboard-statistics-records-box">
                        <div class="dashboard-statistics-record">
                            ...
                            <span class="flex fs20 bold unselectable">{{ $statistics['online-users'] }}</span>
                        </div>
                        <div class="dashboard-statistics-record">
                ...
                <div>
                    ...
                    <div class="my8">
                        <div class="align-center">
                            ...
                            <span class="flex bold fs13">Contact messages : <span class="ml4 black fs14 dashboard-contactmessages-count" style="margin-top: -1px">{{ $statistics['contact-messages'] }}</span></span>
                        </div>
                    </div>
                    <div class="my8">
                        <div class="align-center">
                    ...
                    <div class="my8">
                        <div class="align-center">
                            ...
                            <span class="flex bold fs13">Posts needs review : <span class="ml4 black fs14 dashboard-posts-under-review-count" style="margin-top: -1px">{{ $statistics['posts-under-review'] }}</span></span>
                        </div>
                    </div>
                    <div class="my8">
                        <div class="align-center">
