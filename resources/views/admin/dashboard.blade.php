            ...
            <div class="align-center dark" style="margin-bottom: 10px">
                ...
                <div class="relative" style="margin-left: 10px">
                    ...
                    <div class="suboptions-container typical-suboptions-container" style="width: 160px;">
                        <div class="suboption-style-1 mb2 dashbaord-statistics-filter dsf-selected">
                            <div>
                        ...
                        <div class="suboption-style-1 mb2 dashbaord-statistics-filter">
                            <div>
                        ...
                        <div class="suboption-style-1 dashbaord-statistics-filter">
                            <div>
                        ...
                        <div class="suboption-style-1 dashbaord-statistics-filter">
                            <div>
                                <p class="no-margin bold dark">Total</p>
                                <p class="no-margin fs12 dark">Statistics since this website created</p>
                                <input type="hidden" class="filter" value="total" autocomplete="off">
                                <input type="hidden" class="filter-name" value="Total" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="dashboard-statistics-records-box">
                        <div class="dashboard-statistics-record">
                            ...
                            <span class="flex fs20 bold unselectable">0</span>
                        </div>
                        <div class="dashboard-statistics-record">
                            ...
                            <span id="open-visitors-viewer" class="flex fs20 bold blue unselectable pointer dashboard-visitors-count">0</span>
                        </div>
                        <div class="dashboard-statistics-record">
                            ...
                            <span id="open-newsignups-viewer" class="flex fs20 bold blue unselectable pointer dashboard-signups-count">0</span>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div>
                        <div class="my8">
                            <div class="align-center">
                                ...
                                <span class="flex bold fs13">Posts : <span class="ml4 fs14 dashboard-posts-count" style="margin-top: -1px">0</span></span>
                            </div>
                        </div>
                        <div class="my8">
                            <div class="align-center">
                                ...
                                <span class="flex bold fs13">Comments : <span class="ml4 fs14 dashboard-comments-count" style="margin-top: -1px">0</span></span>
                            </div>
                        </div>
                        <div class="my8">
                            <div class="align-center">
                                ...
                                <span class="flex bold fs13">Claps : <span class="ml4 fs14 dashboard-claps-count" style="margin-top: -1px">0</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="my8">
                        <div class="align-center">
                            ...
                            <span class="flex bold fs13">Contact messages : <span class="ml4 black fs14 dashboard-contactmessages-count" style="margin-top: -1px">0</span></span>
                        </div>
                    </div>
                    <div class="my8">
                        <div class="align-center">
                            ...
                            <span class="flex bold fs13">Author requests : <span class="ml4 black fs14 dashboard-author-requests-count" style="margin-top: -1px">0</span></span>
                        </div>
                    </div>
                    <div class="my8">
                        <div class="align-center">
                            ...
                            <span class="flex bold fs13">Posts needs review : <span class="ml4 black fs14 dashboard-posts-under-review-count" style="margin-top: -1px">0</span></span>
                        </div>
                    </div>
                    <div class="my8">
                        <div class="align-center">
                            ...
                            <span class="flex bold fs13">FAQs : <span class="ml4 black fs14 dashboard-faqs-count" style="margin-top: -1px">0</span></span>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div>
                        <div class="my8">
                            ...
                            <svg class="size14 mr4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 260"><path d="M42.63,256.9c-6.13-2.82-8-7.72-8-14.28q.2-112.38.08-224.77A19.71,19.71,0,0,1,35.48,11,10.49,10.49,0,0,1,46.2,4a10.09,10.09,0,0,1,9.23,8.82,83,83,0,0,1,.24,12.32c-.13,2.76.76,4.1,3.39,5,20.76,7.23,41.37,7.51,61.38-2.13,17.11-8.25,34.6-14.22,53.91-13.41A107.44,107.44,0,0,1,217.51,25.5c4.82,2.35,7,6,7,11.39-.06,34.25,0,68.51,0,102.76,0,9.87-7.5,14.49-16.48,10.29-24.26-11.36-48.53-12-72.64.19-24.91,12.6-50.63,15.48-77.46,7.37a13.42,13.42,0,0,0-2.16-.25v59.92c0,8.73-.23,17.47.07,26.18.23,6.54-2.19,11.05-8.24,13.55ZM55.74,51.26c0,27.25.06,53.91-.07,80.58,0,3.43,2.43,3.58,4.41,4.25,21,7.11,41.62,6.67,61.83-3,4.88-2.33,9.76-4.74,14.82-6.63a97,97,0,0,1,62.43-2.26c3.18.93,4.45.7,4.42-3.24-.18-25-.13-50.05,0-75.07,0-2.66-.56-4.15-3.3-5.07a95.09,95.09,0,0,0-28-5.27c-15.06-.36-28.72,4.53-41.94,11.12a93.58,93.58,0,0,1-28.11,8.64C86.65,57.68,71.41,56.07,55.74,51.26Z" style="fill:#010101"/></svg>
                                <span class="flex bold fs13">Resources Reports : <span class="ml4 black fs14 dashboard-reports-count" style="margin-top: -1px">0</span></span>
                            </div>
                        </div>
                        <div class="my8">
                            <div class="align-center my8">
                                ...
                                <span class="flex bold fs13">Unauthorized actions : <span class="ml4 black fs14 dashboard-unauthorized-actions-count" style="margin-top: -1px">0</span></span>
                            </div>
                        </div>
                        <div class="my8">
                            <div class="align-center my8">
                                ...
                                <span class="flex bold fs13">Newsletter subscriptions : <span class="ml4 black fs14 dashboard-newsletter-count" style="margin-top: -1px">0</span></span>
                            </div>
                        </div>
                    </div>
                </div>
