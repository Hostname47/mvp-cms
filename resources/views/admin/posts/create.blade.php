    ...
    <div id="post-management-panel">
                    ...
                    <div>
                        ...
                        <div class="align-center my4">
                            ...
                            <div class="custom-dropdown-box">
                                ...
                                <div class="custom-dropdown-items-container custom-dropdown-items-container-style">
        ...
        <div class="post-management-panel-section">
            <div class="align-center post-management-panel-section-header">
                ...
                <h2 class="dark fs12 no-margin">Categories</h2>
            </div>
            <div class="post-management-panel-section-content post-management-cateories-box">
