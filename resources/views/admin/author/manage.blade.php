            ...
            @else
                <div class="author-meta-box">
                    <div class="flex">
                        <img src="{{ $author->avatar(100) }}" class="size60 br4 pointer open-image-on-image-viewer" style="margin-right: 12px;">
                        <div class="dark">
                            <p class="no-margin dark bold">{{ $author->fullname }} - <a href="{{ route('admin.users.management', ['user'=>$author->username]) }}" class="blue bold fs12 no-underline">manage user</a></p>
                            <p class="no-margin fs12 mt2">{{ $author->username }}</p>
                            <div class="simple-line-separator my4" style="width: 80px;"></div>
                            <div class="typical-section-style my8 align-center">
                                <svg class="size14 mr8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256,0C114.5,0,0,114.51,0,256S114.51,512,256,512,512,397.49,512,256,397.49,0,256,0Zm0,472A216,216,0,1,1,472,256,215.88,215.88,0,0,1,256,472Zm0-257.67a20,20,0,0,0-20,20V363.12a20,20,0,0,0,40,0V234.33A20,20,0,0,0,256,214.33Zm0-78.49a27,27,0,1,1-27,27A27,27,0,0,1,256,135.84Z"/></svg>
                                <p class="bold dark my4 fs12">This user is not an elected author.</p>
                            </div>
                        </div>
                    </div>
                </div>
