    ...
    <div class="admin-page-content-box">
        ...
        <div id="overview-sections-box">
            ...
            <div class="section">
                ...
                <a href="" class="fs18 bold dark no-underline">Authors - <span class="blue">{{ $statistics['authors'] }}</span></a>
            ...
            <div class="section">
                ...
                <a href="" class="fs18 bold dark no-underline">Submitted posts - <span class="blue">{{ $statistics['posts'] }}</span></a>
