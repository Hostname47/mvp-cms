    ...
    <div class="admin-page-content-box">
        ...
        <div id="overview-sections-box">
            ...
            <div class="section">
                ...
                <a href="{{ route('admin.all.posts', ['status'=>'awaiting-review']) }}" class="fs18 bold dark no-underline">Submitted posts - <span class="blue">{{ $statistics['under-review-posts'] }}</span></a>
