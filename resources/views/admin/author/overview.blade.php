...
<main class="flex flex-column">
    ...
    <div class="admin-page-content-box">
        ...
        <h2 class="no-margin fs18 dark">Overview</h2>
        <p class="lh15 dark my4">Manage author requests and incoming posts</p>
        <div id="overview-sections-box">
            <div class="section">
                <a href="" class="fs18 bold dark no-underline">Author requests - {{ $statistics['requests'] }}</a>
                <p class="dark my8">Review author requests</p>
            </div>
            <div class="section">
                <a href="" class="fs18 bold dark no-underline">Authors posts for review - {{ $statistics['posts'] }}</a>
                <p class="dark my8">Review posts submitted by authors</p>
            </div>
        </div>
