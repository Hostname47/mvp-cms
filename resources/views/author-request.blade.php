...
@section('content')
    ...
    <div class="page-padding">
        ...
        @elseif($status == 'applied-status-not-yet')
        <div class="message-container">
        ...
        <div class="mt8">
            <h3 class="blue">{{ __('Your application') }} :</h3>
            <div class="ml8">
                <div class="align-center">
                    ...
                    <h4 class="dark no-margin">{{ __('Categories') }} :</h4>
                </div>
                @foreach($application->categories('titles') as $category_title)
                <div class="ml8">
                    <p>• {{ __($category_title) }}</p>
                </div>
                @endforeach
                ...
                <div class="align-center">
                    ...
                    <h4 class="dark no-margin">{{ __('Message') }}</h4>
                </div>
                <p class="ml8 lh15 dark">{{ $application->message }}</p>
            </div>
        </div>
        @else
