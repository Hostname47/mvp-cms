...
<div id="auth-section" class="full-center">
    ...
    <div id="register-section" class="full-center" style="margin: 20px 0">
        <div id="auth-viewer-box" class="viewer-box-style-1">
            ...
            <div id="typical-register-box">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <button type="submit" class="typical-button-style dark-bs full-width full-center" style="padding: 12px 0">
