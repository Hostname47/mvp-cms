...
@section('content')
    ...
    <div class="page-padding flex">
        <div id="tags-main">
            ...
            <p id="tag-page-description">{{ __("A tag is a keyword or label that categorizes posts and similar articles more precisely. Using the right tags makes it easier to find relevant articles and posts") }}.</p>
            ...
            <div id="tags-container">
                ...
                @if(!$tags->count())
                <div id="no-posts-found-box" class="full-width">
                    ...
                    <p class="bold-text no-margin">{{ __('No tags found') }}.</p>
                    @if($k)
                    <p class="desc-text no-margin">{{ __('We cannot find any tag that match your search') }}.</p>
                    @else
                    <p class="desc-text no-margin">{{ __('There are no tags available for the moment') }}.</p>
                    @endif
                </div>
                @endif
            </div>
