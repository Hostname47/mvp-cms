    ...
    <div class="page-padding flex">
        <div id="search-main">
            ...
            <div class="page-path-wrapper align-center">
                ...
                <svg class="size10 mx4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M224.31,239l-136-136a23.9,23.9,0,0,0-33.9,0l-22.6,22.6a23.9,23.9,0,0,0,0,33.9l96.3,96.5-96.4,96.4a23.9,23.9,0,0,0,0,33.9L54.31,409a23.9,23.9,0,0,0,33.9,0l136-136a23.93,23.93,0,0,0,.1-34Z"></path></svg>
                <a href="{{ route('search.advanced') }}" class="page-path">
                ...
                <svg class="size10 mx4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path d="M224.31,239l-136-136a23.9,23.9,0,0,0-33.9,0l-22.6,22.6a23.9,23.9,0,0,0,0,33.9l96.3,96.5-96.4,96.4a23.9,23.9,0,0,0,0,33.9L54.31,409a23.9,23.9,0,0,0,33.9,0l136-136a23.93,23.93,0,0,0,.1-34Z"></path></svg>
                <a href="{{ route('search.advanced.results') }}" class="page-path">
            ...
            <div class="align-center mb8">
                ...
                <h1 class="title-style">{{__('Advanced search results')}}</h1>
            </div>
            @if($k)
            <p class="search-result-query-text">{{__('Search results for')}} "<span class="blue unselectable">{{ $k }}</span>"</p>
            @endif

            <p>{{ __('Search filters') }} :</p>
            <div class="adv-search-filters-box">
                <div class="flex">
                    @isset($filters['categories'])
                        <div class="adv-search-filter">
                            <span class="key">{{ __('Categories') }} :</span>
                            @foreach($filters['categories'][1] as $category)
                            <span class="category">{{ __($category) }}</span>
                            @endforeach
                        </div>
                    @endisset
                </div>
                ...
                <div class="flex">
                    @isset($filters['sort'])
                        <div class="adv-search-filter">
                            <span class="key">{{ __('Sort by') }} :</span>
                            <span class="value">{{ $filters['sort'] }}</span>
                        </div>
                    @endisset
                </div>
            </div>
            ...
            <div id="posts-section">
                ...
                <div id="no-results-found-box">
                    ...
                    <p class="desc-text">{{ __('Perhaps you need to change search some of the search filters') }}.</p>
                </div>
                @endif
