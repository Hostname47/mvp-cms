        ...
        <div id="search-main">
            ...
            <div class="full-center">
                <div id="init-search-container">
                    ...
                    @include('search.partials.search-form', ['search_filter'=>true])
                </div>
            </div>
            @else
                <div class="align-center mb8">
                ...
                <div id="authors-section">
                    ...
                    @if($hasmore['authors'])
                    <a href="{{ route('search.authors') }}" id="authors-see-more">
                ...
                <div id="tags-section">
                    <div class="align-center">
                        ...
                        <h3 class="search-resource-title no-wrap mr4">{{ __('Tags') }} - <span class="count">({{ $tags->total() }})</span>-</h3>
