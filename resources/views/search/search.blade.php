        ...
        <div id="search-main">
                            ...
                            <div class="suboptions-container filter-panel">
                                ...
                                <div class="flex flex-column ml8 mt8">
                                    <div class="align-center">
                                        <input type="radio" name="type" id="search-filter-all" checked class="mr6" value="all">
                                        <label for="search-filter-all" class="dark">{{ __('all') }}</label>
                                    </div>
                                    <div class="align-center mt4">
                                        <input type="radio" name="type" id="search-filter-posts" class="mr6" value="posts" autocomplete="off">
                                        <label for="search-filter-posts" class="dark">{{ __('posts') }}</label>
                                    </div>
                                    <div class="align-center mt4">
                                        <input type="radio" name="type" id="search-filter-authors" class="mr6" value="authors" autocomplete="off">
            ...
            <div id="authors-section">
                <div class="align-center">
                    ...
                    <h3 class="search-resource-title">{{ __('Authors') }} - <span class="count">({{ $authors->count() }})</span></h3>
                </div>
                ...
                <div class="align-center my8">
                    <svg class="size14 mx8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256,0C114.5,0,0,114.51,0,256S114.51,512,256,512,512,397.49,512,256,397.49,0,256,0Zm0,472A216,216,0,1,1,472,256,215.88,215.88,0,0,1,256,472Zm0-257.67a20,20,0,0,0-20,20V363.12a20,20,0,0,0,40,0V234.33A20,20,0,0,0,256,214.33Zm0-78.49a27,27,0,1,1-27,27A27,27,0,0,1,256,135.84Z"/></svg>
                    <p class="italic light-gray fs13 no-margin">{{ __('No authors found with your search') }}</p>
                </div>
                @endif
            ...
            <div class="align-center space-between my8">
                <div class="align-center">
                    ...
                    <h3 class="search-resource-title">{{ __('Posts') }} - <span class="count">({{ $posts->count() }})</span></h3>
                </div>
