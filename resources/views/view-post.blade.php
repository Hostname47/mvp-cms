...
@section('content')
    <div id="newsletter-viewer" class="global-viewer full-center" style="background-color: #16171cf0; z-index: 555555">
        <div id="newsletter-viewer-container">
            ...
            <div id="newsletter-submission-section" class="full-center flex-column none">
                ...
                <p class="error none">{{__('Please enter a valid email address')}}</p>
                <input type="text" id="newsletter-subscribe-email-input" placeholder="{{ __('Email Address') }}" autocomplete="off">
            ...
            <div id="newsletter-thankyou-section" class="full-center flex-column">
