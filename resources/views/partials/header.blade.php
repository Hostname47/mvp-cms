        ...
        <div class="header-menu">
            <div class="header-menu-container">
                ...
                <div id="header-discover-button">
                    <a href="{{ route('discover') }}" class="header-menu-button">
                ...
                <a href="{{ route('author-request') }}" class="header-menu-button">
                ...
                <a href="{{ route('about') }}" class="header-menu-button">
                ...
                <a href="{{ route('contact') }}" class="header-menu-button">
