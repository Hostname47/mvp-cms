<header>
    ...
    <div class="align-center header-menu-container">
        ...
        <div class="header-menu-button header-menu-button-with-subcontainers">
    ...
    <div class="header-right-part">
        ...
        <div class="header-login-wrapper">
            ...
            <div class="align-center header-login-button-style login-required">
                ...
                <span class="fs12 bold">Login</span>
            </div>
            @endguest
        </div>
        <span class="mx8 white unselectable">•</span>
