    ...
    <div class="footer-content">
        <div class="logo-section">
            ...
            <div class="sign-up-box my12">
                ...
                <p class="fs13 text">{{__('Sign up and become an insider member')}}</p>
            </div>
            @endguest
        </div>
